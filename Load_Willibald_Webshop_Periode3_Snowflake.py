...
sql_file_path = '/willibald-data/Webshop/_Testdaten_DDL_P3_ANSI.sql'
...
#    '/willibald-data/Webshop/Testdaten Periode 3/href_termintreue.csv',
...
#    '/willibald-data/Webshop/Testdaten Periode 3/ref_produkt_typ.csv',
